...
Ensure **all crop types** are properly suggested and avoid recommending only fruits. Consider local agricultural practices, market opportunities, and practical resources available in India as of March 2025.`;
    ...
    return {
      crops: [
        ...
        {
          name: "Tomato",
          description: "Popular vegetable crop with year-round demand in urban markets, suitable for various climatic conditions.",
          suitabilityScore: 75,
          marketTrend: "rising",
        ...
        {
          name: "Soybean",
          description: "Important oilseed crop with strong domestic and export demand, enriches soil with nitrogen fixation.",
          suitabilityScore: 70,
          marketTrend: "stable",
