...
export const CropContractAgreement = () => {
  ...
  const [formData, setFormData] = useState({
    farmerInfo: {
      farmerName: "Green Valley Farms Ltd.",
      farmerAddress: "123 Rural Road, Farmville",
      farmerContact: "+1 (555) 123-4567",
    },
    buyerInfo: {
      buyerName: "Sunshine Groceries Inc.",
      buyerAddress: "456 Market Street, Cityville",
      buyerContact: "+1 (555) 987-6543",
    },
    cropDetails: {
