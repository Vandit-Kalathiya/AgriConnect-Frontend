...
const ApprovalModal = ({
  ...
  return (
    isApproveModalOpen && (
      <div className="fixed inset-0 bg-opacity-70 backdrop-blur-sm z-50 flex justify-center items-center p-3 sm:p-4 animate-fadeIn">
        <div className="bg-white rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 w-full max-w-md border-t-4 border-green-500">
