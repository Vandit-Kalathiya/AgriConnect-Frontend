...
const ListingForm = () => {
  ...
  return (
    <div className="flex justify-center items-center px-3 sm:px-4 md:px-6 lg:px-8 py-6 md:py-12 md:ml-14 min-h-[calc(100vh-3.5rem)] bg-gray-50 overflow-x-hidden">
