...
Return ONLY valid JSON in this exact format (no markdown, no extra text):
{
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center min-h-[calc(100vh-3.5rem)] md:ml-14 gap-3 px-4">
        <Loader />
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] bg-gray-50 md:ml-14 px-3 sm:px-4 md:px-6 lg:px-8 py-6 overflow-x-hidden">
